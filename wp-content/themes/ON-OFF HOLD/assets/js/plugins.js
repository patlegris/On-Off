...
/**
 * Created by patrick on 27/08/2015.
 */
...
jQuery(document).ready(function($) {
    ...
    $(document).ready(function () {
        ...
        $(".slide#first").backstretch("http://localhost:8080/on-off/wp-content/themes/ON-OFF/assets/images/bg1.jpg");
        $(".slide#sec").backstretch("http://localhost:8080/on-off/wp-content/themes/ON-OFF/assets/images/bg2.jpg");
        $(".slide#thirth").backstretch("http://localhost:8080/on-off/wp-content/themes/ON-OFF/assets/images/bg3.jpg");
        $(".slide#fourth").backstretch("http://localhost:8080/on-off/wp-content/themes/ON-OFF/assets/images/bg4.jpg");
        $(".slide#fifth").backstretch("http://localhost:8080/on-off/wp-content/themes/ON-OFF/assets/images/bg5.jpg");
