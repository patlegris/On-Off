...
<!--BLOC 1-->
<div class="wrapper">
    <img src="<?php echo get_template_directory_uri(); ?>/img/Privatisation_BG01.png"
         alt="Privatisation de ON-OFF Studio" class="clearB">
    ...
    <!--BLOC ASIDE-->
    <div class="blocAside">
        <h2 class="txtAT02"><span class="txtAT02G">AGENDA</span></h2>

        <div class="BlocImg">
            <img src="<?php echo get_template_directory_uri(); ?>/img/Privatisation_AS01.png" alt="Agenda"
                 class="BlocImgBas">
        </div>
    </div>
    ...
    <br>
    <h4 class="txtAT05C2">/--- LE STUDIO ---/</h4>
...
<div class="wrapper4">
    ...
    <div class="blocASS1">
        <h4 class="txtAT05C2">/--- LES CONDITIONS DE PRIVATISATION ---/</h4>
    ...
    <img src="<?php echo get_template_directory_uri(); ?>/img/Privatisation_BG04.png" alt="Tarifs de l'association"
         class="PadTop3">
</div>
