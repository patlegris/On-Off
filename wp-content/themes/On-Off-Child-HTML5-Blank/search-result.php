...
<!--        <span-->
<!--            class="comments">--><?php //if (comments_open(get_the_ID())) comments_popup_link(__('Leave your thoughts', 'html5blank'), __('1 Comment', 'html5blank')); ?><!--</span>-->
...
<!--                <br></p>-->
            ...
            <p class="txtPad01"><?php html5wp_excerpt('html5wp_index');?></p>
