...
if (function_exists('add_theme_support')) {
    ...
    add_image_size('custom-size', 900, 300, true); // Custom Thumbnail Size call using the_post_thumbnail
    //('custom-size');
...
{
    wp_register_script('bootstrap', get_template_directory_uri() . '/js/lib/bootstrap.min.js', array(), '3.3.1'); // bootstrap
    wp_enqueue_script('bootstrap'); // Enqueue it!

    wp_register_script('simpleslider', get_template_directory_uri() . '/js/lib/jquery.simpleslider.package.min.js',
        array('jquery'), '2.6.4'); // simpleslider
    wp_enqueue_script('simpleslider'); // Enqueue it!

    wp_register_script('backstretch', get_template_directory_uri() . '/js/lib/jquery.backstretch.js', array('jquery'), '2.0.4'); // backstretch
...
//  ---------------------------------------------------------------------------------
    ...
    wp_register_script('dropdown', get_template_directory_uri() . '/js/bootstrap-hover-dropdown.js', array('jquery'), '1.0.0'); //
...
// Load HTML5 Blank conditional scripts for front-page.php slider
function html5blank_conditional_scripts()
{
    if (is_page('front-page.php')) {
        wp_register_script('slider', get_template_directory_uri() . '/js/slider.js', array('jquery'), '1.0.0'); //
...
//    wp_enqueue_style('normalize'); // Enqueue it!
    ...
    wp_register_style('bootstrap_theme', get_template_directory_uri() . '/css/bootstrap-theme
    .css', array(), '1.0', 'all');
    wp_enqueue_style('bootstrap_theme'); // Enqueue it!
...
if (function_exists('register_sidebar')) {
    ...
    register_sidebar(array(
        ...
        'description' => __('Widget principal de la barre de menu', 'html5blank'),
        'id' => 'widget-area-1',
